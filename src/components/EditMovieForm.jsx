...
const EditMovieForm = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            ...
            .then((res) => {
                setMovies(res.data);
                history.push(`/moviesDatabase/${movie.id}`);
            })
            .catch((err) => console.log(err));
    };
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="px-5 py-3">
                    <div className="py-2">
                        ...
                        <input
                            className="dark:bg-slate-800 dark:text-white border-2 border-black border-solid"
                            value={title}
                    ...
                    <div className="py-2">
                        ...
                        <textarea
                            className="dark:bg-slate-800 dark:text-white border-2 border-black border-solid w-full 
                            scroll-p-80"
                            value={description}
                            onChange={handleChange}
                            name="description"
                ...
                <div className="px-5 py-4 border-t border-zinc-200 flex justify-end gap-2">
                    <Link to={`/moviesDatabaseList`} className="myButton bg-zinc-500 p-1 rounded">
                        Vazgeç
                    </Link>
                    <button
                        type="submit"
                        className="myButton bg-green-700 hover:bg-green-600 p-1 rounded"
                    >
